---
name: probe-skills-control
description: Diagnostic probe reporting its own spawn-time context. The negative control - no skills field. Installed and removed by run-probes.sh. Not for general use.
tools: WebSearch
model: haiku
maxTurns: 2
---
